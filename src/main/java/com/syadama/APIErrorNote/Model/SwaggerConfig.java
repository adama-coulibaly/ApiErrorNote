...
@EnableSwagger2
/* la concaténation de plusieurs annotations, et son objectif est de declencher
/toute la mécanique interne de spring*/
@SpringBootApplication
public class SwaggerConfig {

    //indique à la méthode de produire un bean à gérer par spring container
    @Bean
    public Docket api() {
